...
*/
  // Hook #1: Load all perks on initial mount
  useEffect(() => {
  ...
  // Hook #2: Auto-search (debounced) when user types or changes filter
  useEffect(() => {
    // Debounce network requests while user types
    const t = setTimeout(() => {
      // Load perks with current search & merchant filter
      loadAllPerks();
    }, 450);

    return () => clearTimeout(t);
    // We intentionally include searchQuery and merchantFilter
